...
int main(int argz, char** argv)
{
  ...
  {
    fprintf(stderr,
      "div_test - validate implementation of division.\n"
      "Usage:\n"
      "div_test nIter\n"
      );
    return 1;
  ...
  boost_quadfloat_t ref1, ref2, ref12, ref21;
  extfloat128_t       res1, res2, res12, res21;
  uint64_t n = 1;
  while (nIter > 0) {
    ...
    ref12 = ref1 / ref2; ref21 = ref2 / ref1;
    res12 = res1 / res2; res21 = res2 / res1;

    if (!isEqual(res12, ref12)) {
      report_mismatch(res1, res2, n);
      return 1;
    }
    if (!isEqual(res21, ref21)) {
      report_mismatch(res2, res1, n);
      return 1;
    }
